...
class CRM_Sparkpost {
  ...
  public static function getSetting($setting = NULL) {
    ...
    foreach (array('sparkpost_apiKey', 'sparkpost_useBackupMailer', 'sparkpost_campaign', 'sparkpost_ipPool', 'sparkpost_customCallbackUrl', 'sparkpost_host', 'sparkpost_sending_quota') as $name) {
