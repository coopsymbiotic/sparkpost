...
class CRM_Sparkpost_ExtensionUtil {
  ...
  const LONG_NAME = 'com.cividesk.email.sparkpost';
 ...
 */
function _sparkpost_civix_civicrm_postInstall() {
  _sparkpost_civix_civicrm_config();
  if ($upgrader = _sparkpost_civix_upgrader()) {
 ...
 */
function _sparkpost_civix_civicrm_themes(&$themes) {
  $files = _sparkpost_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
 ...
 */
function _sparkpost_civix_civicrm_entityTypes(&$entityTypes) {
